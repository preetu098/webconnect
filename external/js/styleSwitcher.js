...
(function($) {
	...
	sidebarPositionSelect.on('change', function() {
		this.value === "fixed" && body.attr('data-sidebar-style') === "modern" && body.attr('data-layout') === "horizontal" ? alert("Sorry, Modern sidebar layout dosen't support fixed position!") : body.attr('data-sidebar-position', this.value);
	...
	sidebarStyleSelect.on('change', function() {
		...
		if (body.attr('data-layout') === "horizontal") {
			if (body.attr('data-container') === "boxed" && this.value === "full") {
				alert("Sorry! Full menu is not available in horizontal Boxed layout.");
				return;
			}
