            ...
            <div class="modal fade" id="uplcard">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="row" id="emUplcard" action="<?= base_url('clients/uplcard/'); ?><?= $cid; ?>/<?= $pid; ?>"
                           ...
                           ?>
                                    <tr>
                                        ...
                                        <td><a style="width: 50px;"
                                                href="<?= base_url('external/uploads/policy_cards/' . $cid . '_' . $pid . '/'); ?><?=str_replace('#', '%23', $emp->card); ?>.pdf"
                                                download>
                                                <?= $emp->card; ?></a></td>
                                        </td>
                                                        ...
                                                        <div class="modal-body">
                                                         ...
                                                         ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><a style="width: 50px;"
                                                                                href="<?= base_url('external/uploads/policy_cards/' . $cid . '_' . $pid . '/'); ?><?= $rel->card; ?>.pdf"
                                                                                download><?= $emp->card; ?></a></td>
                                                                        <td>Name :- <?= $rel->name; ?><br>
                                                                            Email :- <?= $rel->email; ?><br>
                                                                            Phone :- <?= $rel->phone; ?>
                                                                        </td>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" onclick="hideModal()" id="hideModal" class="btn btn-danger" style="background: #fe6550;">Close</button>
    </div>
    </div>
  </div>
</div>
...
function downloadCard(cid, pid, cardid, emp_id)
{
    $('#myModal').modal('show');
    event.preventDefault();
    $.ajax({
        url: "<?= base_url('clients/downloadCard') ?>",
        type: "GET",
        data: {
            'cid' : cid,
            'pid' : pid,
