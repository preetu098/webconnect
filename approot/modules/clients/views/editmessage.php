               ...
               <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                       ...
                       <?php 
                        $wel = $this->qm->all("welcomemsg_tbl","*",array('id'=>$id));
                        foreach ($wel as $wel);
                          
                    ?>
                    <form method="POST" action="<?= base_url('clients/updmsg');?>/<?= $id;?>/<?= $cid;?>/<?= $pid;?>">
                                                       <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="form-label">Message Type</label>
                                                            <input type="text" name="type" value="<?= $wel->type;?>" class="form-control">
                                                        </div>
                                                         <div class="col-lg-9">
                                                            <label class="form-label my-2">Message</label>
                                                            <textarea id="ckeditor" class="form-control" name="msg"><?= $wel->msg;?></textarea>
                                                        </div>
