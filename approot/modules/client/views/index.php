  ...
  <div class="authincation h-100" style="background:#fff;">
    <div class="container h-100">
      <div class="row justify-content-center h-100 align-items-center">
                ...
                <div class="auth-form">
                  <div class="text-center mb-3">
                    ...
                    <div class="row">
                      <div class="col-xl-6">
                        <br><br><br>
                        <a href="javascript:void;"><img src="<?= base_url('external/'); ?>images/logo.png"
                      ...
                      <div class="col-xl-6">
                        ...
                        foreach ($client as $client)
                          ;
                        ?>
                        <a href="javascript:void;"><img src="<?= base_url('external/uploads/'); ?><?= $client->image; ?>"
        ...
        <div class="col-md-6">
          <img src="<?= base_url('external/'); ?>images/emloyee-loin.jpg" class="img-responsive" style="width:100%"
            alt="">
        </div>
      </div>
    </div>
