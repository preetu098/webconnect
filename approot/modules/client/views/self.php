                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="mb-3 col-md-6" >
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input type="text" disabled class="form-control" style="background:#f8f8f8" value="<?= $uemp->doj;?>" placeholder="Date of joining">
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                   ...
                                                   <div class="mb-3 col-md-6">
                                                      <label class="form-label">Status</label>
                                                       <select class="form-control" name="gender" disabled style="background:#f8f8f8">
                                                           <option value="1" <?=($uemp->status == '1')?"selected":"";?>>Active</option>
                                                           <option value="0" <?=($uemp->status == '0')?"selected":"";?>> In Active</option>
                                                           </select>
                                                   </div>
...
-->
                                                ...
                                                <a href="javascript:;" onclick="location.href = '<?= base_url('employee/updself/'.$cid.'/'.$pid.'/'.$eid);?>';" class="btn btn-primary"> Need Correction? </a>
                                            <!-- </form>-->
</div>
