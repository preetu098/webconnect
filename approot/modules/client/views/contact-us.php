<section style="background-color: #fff; padding-top: 98px;">
    <div class="container">
        <div class="row">
            <div class="contact-heading">
                <select class="form-control" style="width: 40%;" onchange="showcontact(this.value)">
                    <option>Select Policy</option>
                    <?php
                         $pol = $this->qm->all("ri_clientpolicy_tbl","*",array('cid'=>$cid));
                         foreach($pol as $pol){
                         ?>
                            <option value="<?=$pol->id?>"><?=$pol->policy_num?></option>
                         <?php } ?>
                </select>
                <hr>
