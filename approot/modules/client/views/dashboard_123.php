            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="row">
                       <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
                        <div class="widget-stat card bg-deflt">
                           <div class="card-body  p-4">
                                 <div class="media">
                                    <span class="me-3 bgl-primary">
                                    <img src="<?= base_url('external/');?>images/icons/client-dsh/activepolicie.png" class="img-cstm-cod img-responsive" />
                                    </span>
                                 <div class="media-body text-white">
                                    <p class="mb-1">Active Policies</p>
                        ...
                        <div class="widget-stat card bg-deflt">
                           <div class="card-body  p-4">
                                 <div class="media">
                                    <span class="me-3">
                                    <img src="<?= base_url('external/');?>images/icons/client-dsh/Expire.png" class="img-cstm-cod img-responsive" />
                                    </span>
                                 <div class="media-body text-white">
                                    <p class="mb-1">Expired Policies</p>
                  ...
                  <div class="row">
                     <div class="col-xl-4">
                     <div class="card">
                        <img class="card-img-top img-fluid" src="<?= base_url('external/');?>images/card/2.png" alt="Card image cap">
