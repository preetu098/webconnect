            ...
            <div class="row justify-content-center h-100 align-items-center">
               <div class="col-md-6">
                  ...
                  ?>
                              ...
                              <form method="POST" action="<?= base_url('employee/reg/');?><?= $cid;?>/<?= $pid;?>">
                                    <?php 
                  ...
                  <input type="hidden" name="client_name" value="<?= $cl->cname;?>">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="emp_id" placeholder="Employee Id">
                                 </div>
                                 <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" required name="email" placeholder="hello@example.com">
                                 </div>
                                  <div class="mb-3">
                                    <label class="mb-1"><strong>Mobile</strong></label>
                                    <input type="text" class="form-control" required name="mobile" placeholder="1234567890">
                                 </div>
                                 <div class="mb-3">
                                    <label class="mb-1"><strong>Password</strong></label>
                                    <input type="password" required class="form-control" required name="password" value="Password">
                                 </div>
