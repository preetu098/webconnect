                ...
                <div class="col-xl-12">
                  ...
                  ?>
                    ...
                    <form  method="POST" class="signin">
                      ...
                      <div class="mb-3">
                        <label class="mb-1"><strong>Registered Email</strong></label>
                        <input type="email" name="regname" class="form-control" required placeholder="Email">
                      </div>
                      <div class="row d-flex justify-content-between mt-4 mb-2">
                        
                        <div class="mb-3">
                          <a href="<?=base_url('employee/login/')?>" >Back to Login</a>
                        </div>
                      </div>
                      <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-block">Know your password</button>
                      </div>
                    </form>
