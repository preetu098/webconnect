<div class="basic-form">
   <?php 
                                                ...
                                                ?>
   <form method="POST" action="<?= base_url('user/mother/');?><?= $cid;?>/<?= $pid;?>/<?= $eid;?>" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="mb-3 col-md-6">
                                                      <label class="form-label">DOB</label>
                                                       <input type="date" name="dob" id="dob4" class="form-control" value="<?= !empty($spouse->dob)?$spouse->dob:'';?>" placeholder="Dob">
                                                   </div>
                                                    <div class="mb-3 col-md-6">
                                                      <label class="form-label">Age</label>
                                                       <input type="text" name="age" id="age4" class="form-control" value="<?= !empty($spouse->age)?$spouse->age:'';?>" placeholder="Age">
                                                   </div>
